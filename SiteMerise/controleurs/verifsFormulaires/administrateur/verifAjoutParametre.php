...
if ($erreur != 0) {
    header('Location: ../../../vue/administrateur/gererCorrectionDD.php?erreur=' . $erreur . '&idExercice=' . $idExercice);
}
else {
    ...
    header('Location: ../../../vue/administrateur/gererCorrectionDD.php?idExercice=' . $idExercice);
