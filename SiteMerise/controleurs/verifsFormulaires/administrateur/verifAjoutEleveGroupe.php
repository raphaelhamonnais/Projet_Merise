...
if (!$bonGroupe) {
    ...
    if ($somme == 0) { // tout est ok
        ...
        header('Location: ../../../vue/administrateur/ajoutEtudiantGroupe.php?ajoutOK=1&idGroupe=' . $idGroupe . '&origin=' . $origin);
        ...
        header('Location: ../../../vue/administrateur/ajoutEtudiantGroupe.php?erreur=' . $somme . '&idGroupe=' . $_POST['choixGroupe'] . $saveForm  . '&origin=' . $origin);
    }
}