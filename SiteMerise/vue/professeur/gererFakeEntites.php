...
if (isset($_GET['delEntite'])) { // delEntite contient l'ID_MEA du MEA de correction de l'exercice
    ...
    QueryFunctions::supprimerEntiteFake($bdd, $_GET['delEntite'], $nomEntite);
    header('Location: gererFakeEntites.php?idExercice=' . $idExercice);
}
...
$listeEntitesFakes = QueryFunctions::getEntitesSeulementDuFake($bdd, $idExercice);
...
<div class="container">
    ...
    <div class="container-fluid">
        <ul class="nav nav-tabs">
            ...
            <?php }
                ...
                <li role="presentation" class="active"><a href="gererFakeEntites.php?idExercice=<?php echo $idExercice; ?>">Entités</a></li>
            <?php } ?>
    ...
    <div class="container-fluid">
        <div class="col-md-6">
            <h4 class="text-center">Liste de vos fausses Entités </h4>
            <br/>
            <table class="table table-striped">
                ...
                <?php
                while ($row = $listeEntitesFakes->fetch()) {
                    ?>
                    <tr>
                        <td><?php echo $row['Nom_Entite']; ?></td>

                        <td class="table_icon">
                            <a href="<?php echo "gererFakeEntites.php?delEntite=" . $infosExercices['ID_MEA_Fake'] . '&nomEntite=' . $row['Nom_Entite'] . '&idExercice=' . $idExercice;?>">
        ...
        <div class="col-md-6">
            ...
            <br/>
            <form class="form-inline" method="post" action="../../controleurs/verifsFormulaires/professeur/verifAjoutEntiteFake.php">
                <input class="hidden" type="text" name="idExercice" value="<?php echo $idExercice;?>"/>
                <input class="hidden" type="text" name="ID_MEA_Fake" value="<?php echo $infosExercices['ID_MEA_Fake'];?>"/>
    ...
    <!-- Entités de la correction -->
    <div class="container-fluid">
        <div class="col-md-6">
            <h4 class="text-center">Liste des Entités de la Correction </h4>
            <br/>
            <table class="table table-striped">
                <tr>
                    <th>Nom</th>
