...
<div class="container">
    ...
    <div class="container-fluid">
        <form class="form-horizontal" method="post" action="../../controleurs/verifsFormulaires/administrateur/verifEditionGroupe.php">
            ...
            <!-- Annuler -->
            <?php
            if ($origin == 2) {// On vient de la page vueUnePromo
                    ?>
